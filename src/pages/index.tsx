...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`π Tech Heart`}</title>

        <meta
          name="description"
          content="Welcome to π Tech Heart - Your Gateway to Knowledge. Upload, Share, and Discover Educational Videos with Ease and Simplicity."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlZHVjYXRpb24lMkN2aWRlbyUyMHVwbG9hZHxlbnwwfHx8fDE2ODk4Mjc3ODh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to π Tech Heart - Your Gateway to Knowledge. Upload, Share, and Discover Educational Videos with Ease and Simplicity.`}
            </Text>
            <Box
